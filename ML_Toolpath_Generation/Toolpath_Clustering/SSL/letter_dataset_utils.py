...
def letter_to_mask(letter, image_size=100, font_size=80, font_path="arial.ttf"):
    """
...
def generate_letter_dataset(letters, output_folder="letter_dataset", image_size=100):
    """
    ...
    for letter in letters:
        mask = letter_to_mask(letter, image_size=image_size)
